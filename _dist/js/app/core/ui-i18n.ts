...
const STRINGS = {
  es: {
    ...
    listenTip: "Escuchar la justificación",
    playAudioAria: "Reproducir audio de pregunta y opciones",
    playTipAria: "Reproducir audio de justificación",
    pauseAudioAria: "Pausar audio",
    stopAudioAria: "Detener audio",
    seekAudioAria: "Posición del audio",
    ...
    chipVideo: "Video explicativo (YouTube)",
    videoTitle: "Video explicativo",
    videoHint: "Cómo usar el simulador PCNSE",
    repoLink: "Repositorio",
    repoLinkAria: "Abrir repositorio en GitHub",
    repoLinkTitle: "PCNSE 150 preguntas — codigo abierto en GitHub",
  ...
  en: {
    ...
    chipVideo: "Walkthrough video (YouTube)",
    videoTitle: "Walkthrough video",
    videoHint: "How to use the PCNSE simulator",
    repoLink: "Repository",
    repoLinkAria: "Open repository on GitHub",
    repoLinkTitle: "PCNSE 150 preguntas — open source on GitHub",
